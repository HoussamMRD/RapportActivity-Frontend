                ...
                children: [
                    {
                        id: 'EmplyeesId',
                        title: 'Eployees',
                        translate: 'MENU.RH.ADMIN.EMPLOYEES',
                        type: 'item',
                        icon: 'slack',
                        roles: [Role.ADMIN],
                        url: '/projets/rh/employees',
                    },
                    {
                        id: 'CongeId',
                        title: 'Conge',
                        translate: 'MENU.RH.ADMIN.CONGE',
                        type: 'item',
                        icon: 'slack',
                        roles: [Role.ADMIN],
                        url: '/projets/rh/addEmploye',
                    },
                    {
                        id: 'Absence',
                        title: 'Absence',
                        translate: 'MENU.RH.ADMIN.ABSENCE',
                        type: 'item',
                        icon: 'slack',
                        roles: [Role.ADMIN],
                        url: '/projets/rh/absence',
                    }
                ]
            },
            {
                ...
                translate: 'MENU.RH.FORMATION',
                type: 'item',
                icon: 'slack',
                roles: [Role.ADMIN],
                url: 'projets/rh/formation',
            },
            {
                id: 'pointage',
                title: 'Pointage',
                translate: 'MENU.RH.POINTAGE',
                type: 'item',
                icon: 'slack',
                roles: [Role.ADMIN],
                url: 'projets/rh/pointage',
            }
        ]
    }
